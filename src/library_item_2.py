...
class ArchiveRecord(AbstractArchiveItem):
    ...
    def matches_keyword(self, keyword):
        ...
        return (
            keyword in self._metadata["name"].lower()
            or any(keyword in tag.lower() for tag in self._tags)
        )

    # ----- Polymorphic Methods -----

    def display_info(self):
        """Display record-specific info (polymorphic override)."""
    ...
    def calculate_size(self):
        """Return file size in KB (polymorphic override)."""
